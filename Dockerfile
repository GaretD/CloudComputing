...
RUN set -eux; \
    ...
    echo "deb [arch=amd64 signed-by=/etc/apt/keyrings/mysql.gpg] https://repo.mysql.com/apt/debian/ bookworm mysql-8.4-lts mysql-tools" > /etc/apt/sources.list.d/mysql.list; \
    apt-get update; \
